...
| 6   | **Demo chính thức & tổng kết:**<br>- Trình bày toàn bộ dự án trước nhóm/mentor: chạy trực tiếp từ upload tài liệu → hỏi đáp → xem alert giả lập → xem báo cáo RAGAS.<br>- Ghi nhận góp ý (chủ yếu xoay quanh việc mở rộng bộ câu hỏi đánh giá và cân nhắc thêm rate-limiting cho API).<br>- Tổng kết lại toàn bộ hành trình 5 tuần và note các hướng phát triển tiếp theo.                                                                          | 07/08/2026   | 07/08/2026      | Dự án cá nhân                                                                                         |
