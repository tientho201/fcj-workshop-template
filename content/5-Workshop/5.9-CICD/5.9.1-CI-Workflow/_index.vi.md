...
![5 job của ci.yml chạy trên 1 Pull Request](../images/01-ci-yml-5-jobs.png)
*Tab Actions trên GitHub: 5 job của `ci.yml` trên 1 PR (gồm `python-test`), kèm kết quả pass/fail.*

---

Tiếp theo: [5.9.2 - deploy.yml — Vấn đề Required reviewer và cách sửa](../5.9.2-Deploy-Workflow/)
