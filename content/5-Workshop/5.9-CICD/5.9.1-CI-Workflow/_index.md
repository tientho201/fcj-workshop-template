...
![Five ci.yml jobs on one Pull Request](../images/01-ci-yml-5-jobs.png)
*GitHub Actions tab: the five `ci.yml` jobs on a PR, including `python-test`, with pass/fail results.*

---

Next: [5.9.2 - deploy.yml — Required Reviewer Issue and Fix](../5.9.2-Deploy-Workflow/)
